...
export function getEmailResetEmailTemplate(userEmail) {
    return [
        ...
        '----------------------',
        '',
        `Your email address for DatopicMeet has been changed to ${userEmail}.`,
...
export function getJoinEmailTemplate(sender, userEmail, team, isGuest = false) {
    ...
    return [
        ...
        `${isGuest ? 'You were invited as a guest to collaborate with the team' : 'Start collaborating with your team on DatopicMeet'}`,
        '',
...
export function getMentionEmailTemplate(sender, message, postId, siteName, teamName, channelDisplayName) {
    ...
    return [
        ...
        '',
        `Reply in DatopicMeet ( ${baseUrl}/landing#/${teamName}/pl/${postId} )`,
        '',
        `@${sender}`,
...
export function getEmailVerifyEmailTemplate(userEmail) {
    ...
    return [
        ...
        '',
        'This email address was used to create an account with DatopicMeet.',
