...
const argv = yargs(process.argv.slice(1)).
    ...
    help().
    epilog('Copyright (c) 2015-present DatopicMeet, Inc. All Rights Reserved.').
    argv;
...
const emojiJSX = `// Copyright (c) 2015-present DatopicMeet, Inc. All Rights Reserved.
// See LICENSE.txt for license information.
...
const emojiGo = `// Copyright (c) 2015-present DatopicMeet, Inc. All Rights Reserved.
// See LICENSE.txt for license information.
